...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Run frozen YOLO on synchronized nuScenes six-camera clips."
    )
    parser.add_argument(
        "--metadata-root",
        default=(
            "/data5/lzx_data/Zhijia-Guardian/datasets/"
            "nuscenes_mini/extracted/v1.0-mini"
        ),
    )
    parser.add_argument(
        "--data-root",
    ...
    parser.add_argument(
        ...
        default=(
            "/data5/lzx_data/Zhijia-Guardian/datasets/"
            "nuscenes_mini/yolo_multicam_v0_2"
        ),
    )
