...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Record CARLA closed-loop diagnosis benchmark.")
...
def main() -> None:
    args = parse_args()
    manifest = record_carla_closed_loop_benchmark(
        args.output_root,
        host=args.host,
        port=args.port,
        town=args.town,
