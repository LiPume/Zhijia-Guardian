...
The implementation uses the OpenAI Python SDK's native Pydantic structured-output support. The default endpoint
is the Responses API; `chat_completions` remains configurable for compatible services. See the official
