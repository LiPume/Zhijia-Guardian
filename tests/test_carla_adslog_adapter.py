...
def test_carla_compatible_adslog_adapter_has_no_runtime_dependency(tmp_path):
  ...
  path.write_text(json.dumps({"case_id": "carla-small", "route_id": "Town01/route-1", "records": [
    {"timestamp_s": 0.0, "topic": "zgAux.perceptionEvidence", "payload_summary": {"leadVisible": True}},
  ...
  assert [item.topic for item in case.messages] == ["zgAux.perceptionEvidence", "longitudinalPlan", "carControl"]
